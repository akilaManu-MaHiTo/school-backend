...
class OrganizationService
{
    ...
    /**
     * Upload an image (e.g., logo/insight) to GCS.
     *
     * @return array{gsutil_uri:string,fileName:string,path:string}
     */
    public function uploadImageToGCS(UploadedFile $file, string $dir = 'organization'): array
    {
    ...
    /**
     * Return signed URL and file name for a gs:// URI or object path.
     *
    ...
    /**
     * Remove an old image from storage.
     */
